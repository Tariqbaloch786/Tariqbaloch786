<h1 align="center">Hey, I'm Tariq Baloch 👋</h1>

<p align="center">
  <em>Full-stack engineer & computer-vision specialist. I build end-to-end products — from Laravel/Node APIs and Flutter apps to Python desktop software and trained CV models.</em>
</p>
...
```text
🌐  Web         →  Laravel, PHP, Node.js, Express, REST & realtime APIs
📱  Mobile      →  Flutter (iOS + Android from one codebase)
💻  Desktop     →  Python, Flask, pywebview — packaged Windows installers
🧠  AI & CV     →  Computer vision, custom model training, OpenCV, PyTorch
...
📧 **[tariqbalochtariq295@gmail.com](mailto:tariqbalochtariq295@gmail.com)**
